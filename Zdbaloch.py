#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To zahoordeen
...
---------------------------------------------
\033[1;96m|-------+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-----|
\033[1;96m|               Pak Anonymous    z.deen           |
\033[1;96m|This Tool is Only for Bangladesh FB Acounts|
\033[1;96m|------+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+------|

\033[1;91m [⚡\033[1;97mAuthor Name: zahoordeen    ⚡\033[1;91m]
\033[1;91m [⚡\033[1;97mYutube Chnl: ⚡\033[1;91m]
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #zahoordeen
	    time.sleep(2)
            loop = 'false'
        else:
...
def menu():
	...
	try:
		...
		keluar()
	os.system("clear") #zahoor:Deen_baloch
	print logo
